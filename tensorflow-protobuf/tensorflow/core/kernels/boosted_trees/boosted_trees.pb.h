...
void InitDefaultsCategoricalSplitImpl();
void InitDefaultsCategoricalSplit();
void InitDefaultsDenseSplitImpl();
void InitDefaultsDenseSplit();
...
class Node : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.boosted_trees.Node) */ {
 public:
  ...
  private:
  void _slow_mutable_categorical_split();
  public:
  ...
  private:
  void _slow_mutable_dense_split();
  public:
...
class CategoricalSplit : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.boosted_trees.CategoricalSplit) */ {
 public:
  ...
  inline CategoricalSplit* New() const PROTOBUF_FINAL { return New(NULL); }

  CategoricalSplit* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_tensorflow_2fcore_2fkernels_2fboosted_5ftrees_2fboosted_5ftrees_2eproto::TableStruct;
  friend void ::protobuf_tensorflow_2fcore_2fkernels_2fboosted_5ftrees_2fboosted_5ftrees_2eproto::InitDefaultsCategoricalSplitImpl();
};
// -------------------------------------------------------------------
...
class DenseSplit : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.boosted_trees.DenseSplit) */ {
 public:
  ...
  inline DenseSplit* New() const PROTOBUF_FINAL { return New(NULL); }

  DenseSplit* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_tensorflow_2fcore_2fkernels_2fboosted_5ftrees_2fboosted_5ftrees_2eproto::TableStruct;
  friend void ::protobuf_tensorflow_2fcore_2fkernels_2fboosted_5ftrees_2fboosted_5ftrees_2eproto::InitDefaultsDenseSplitImpl();
};
// -------------------------------------------------------------------
...
class DebugOutput : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.boosted_trees.DebugOutput) */ {
 public:
  ...
  inline DebugOutput* New() const PROTOBUF_FINAL { return New(NULL); }

  DebugOutput* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_tensorflow_2fcore_2fkernels_2fboosted_5ftrees_2fboosted_5ftrees_2eproto::TableStruct;
  friend void ::protobuf_tensorflow_2fcore_2fkernels_2fboosted_5ftrees_2fboosted_5ftrees_2eproto::InitDefaultsDebugOutputImpl();
};
// ===================================================================
...
inline ::tensorflow::boosted_trees::CategoricalSplit* Node::mutable_categorical_split() {
  if (!has_categorical_split()) {
    ...
    set_has_categorical_split();
    node_.categorical_split_ = 
      ::google::protobuf::Arena::CreateMessage< ::tensorflow::boosted_trees::CategoricalSplit >(
      GetArenaNoVirtual());
  }
...
inline ::tensorflow::boosted_trees::DenseSplit* Node::mutable_dense_split() {
  if (!has_dense_split()) {
    ...
    set_has_dense_split();
    node_.dense_split_ = 
      ::google::protobuf::Arena::CreateMessage< ::tensorflow::boosted_trees::DenseSplit >(
      GetArenaNoVirtual());
  }
...
template <> struct is_proto_enum< ::tensorflow::boosted_trees::BucketizedSplit_DefaultDirection> : ::google::protobuf::internal::true_type {};
template <>
