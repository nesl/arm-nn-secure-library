...
void InitDefaultsSessionMetadataImpl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
void InitDefaultsSessionMetadata() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsSessionMetadataImpl);
}
...
void InitDefaultsConfigProto_ExperimentalImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_tensorflow_2fcore_2fprotobuf_2fconfig_2eproto::InitDefaultsSessionMetadata();
  {
...
void InitDefaultsRunMetadata_FunctionGraphsImpl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
void InitDefaultsRunMetadata_FunctionGraphs() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsRunMetadata_FunctionGraphsImpl);
}
...
void InitDefaultsRunMetadataImpl() {
  ...
  protobuf_tensorflow_2fcore_2fframework_2fgraph_2eproto::InitDefaultsGraphDef();
  protobuf_tensorflow_2fcore_2fprotobuf_2fconfig_2eproto::InitDefaultsRunMetadata_FunctionGraphs();
  {
...
void InitDefaultsCallableOptions_FeedDevicesEntry_DoNotUseImpl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
void InitDefaultsCallableOptions_FeedDevicesEntry_DoNotUse() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsCallableOptions_FeedDevicesEntry_DoNotUseImpl);
}

void InitDefaultsCallableOptions_FetchDevicesEntry_DoNotUseImpl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
void InitDefaultsCallableOptions_FetchDevicesEntry_DoNotUse() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsCallableOptions_FetchDevicesEntry_DoNotUseImpl);
}
...
void InitDefaultsCallableOptionsImpl() {
  ...
  protobuf_tensorflow_2fcore_2fprotobuf_2fconfig_2eproto::InitDefaultsCallableOptions_FeedDevicesEntry_DoNotUse();
  protobuf_tensorflow_2fcore_2fprotobuf_2fconfig_2eproto::InitDefaultsCallableOptions_FetchDevicesEntry_DoNotUse();
  {
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
            static_cast< ::google::protobuf::uint8>(10u /* 10 & 0xFF */)) {
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessage(input, add_virtual_devices()));
        } else {
          goto handle_unusual;
        }
        break;
...
::google::protobuf::uint8* ConfigProto_Experimental::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_session_metadata()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        11, *this->session_metadata_, deterministic, target);
  }
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 12: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessage(input, add_session_inter_op_thread_pool()));
        } else {
          goto handle_unusual;
        }
        break;
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
            static_cast< ::google::protobuf::uint8>(10u /* 10 & 0xFF */)) {
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessage(input, add_partition_graphs()));
        } else {
          goto handle_unusual;
        }
        break;
...
void RunMetadata_FunctionGraphs::SerializeWithCachedSizes(
  ...
  for (unsigned int i = 0,
    ...
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      1, this->partition_graphs(static_cast<int>(i)), output);
  }
...
::google::protobuf::uint8* RunMetadata_FunctionGraphs::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_pre_optimization_graph()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        2, *this->pre_optimization_graph_, deterministic, target);
  }
  ...
  if (this->has_post_optimization_graph()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        3, *this->post_optimization_graph_, deterministic, target);
  }
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 4: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
            static_cast< ::google::protobuf::uint8>(34u /* 34 & 0xFF */)) {
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessage(input, add_function_graphs()));
        } else {
          goto handle_unusual;
        }
        break;
...
void RunMetadata::SerializeWithCachedSizes(
  ...
  for (unsigned int i = 0,
    ...
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      4, this->function_graphs(static_cast<int>(i)), output);
  }
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 5: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
            static_cast< ::google::protobuf::uint8>(42u /* 42 & 0xFF */)) {
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessage(input, add_tensor_connection()));
        } else {
          goto handle_unusual;
        }
        break;
...
void CallableOptions::SerializeWithCachedSizes(
  ...
  if (!this->feed_devices().empty()) {
    ...
    if (output->IsSerializationDeterministic() &&
      ...
      ::std::sort(&items[0], &items[static_cast<ptrdiff_t>(n)], Less());
      ::google::protobuf::scoped_ptr<CallableOptions_FeedDevicesEntry_DoNotUse> entry;
      for (size_type i = 0; i < n; i++) {
  ...
  if (!this->fetch_devices().empty()) {
    ...
    if (output->IsSerializationDeterministic() &&
      ...
      ::std::sort(&items[0], &items[static_cast<ptrdiff_t>(n)], Less());
      ::google::protobuf::scoped_ptr<CallableOptions_FetchDevicesEntry_DoNotUse> entry;
      for (size_type i = 0; i < n; i++) {
