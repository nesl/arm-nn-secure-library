...
void InitDefaultsVerifierConfigImpl() {
...
void InitDefaultsVerifierConfig() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsVerifierConfigImpl);
}
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "tensorflow/core/protobuf/verifier_config.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
VerifierConfig::VerifierConfig()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_tensorflow_2fcore_2fprotobuf_2fverifier_5fconfig_2eproto::InitDefaultsVerifierConfig();
  }
  SharedCtor();
