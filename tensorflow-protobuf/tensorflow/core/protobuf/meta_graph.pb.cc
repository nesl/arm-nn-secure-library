...
void InitDefaultsMetaGraphDefImpl() {
  ...
  protobuf_tensorflow_2fcore_2fprotobuf_2fsaved_5fobject_5fgraph_2eproto::InitDefaultsSavedObjectGraph();
  {
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 6: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
            static_cast< ::google::protobuf::uint8>(50u /* 50 & 0xFF */)) {
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessage(input, add_asset_file_def()));
        } else {
          goto handle_unusual;
        }
        break;
...
;
  ...
  if (this->has_object_graph_def()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        7, *this->object_graph_def_, deterministic, target);
  }
