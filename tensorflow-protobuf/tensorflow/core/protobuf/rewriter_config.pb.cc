    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 200: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessage(input, add_custom_optimizers()));
        } else {
          goto handle_unusual;
        }
        break;
...
::google::protobuf::uint8* RewriterConfig::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_inter_optimizer_verifier_config()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        300, *this->inter_optimizer_verifier_config_, deterministic, target);
  }
  ...
  if (this->has_post_optimization_verifier_config()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        301, *this->post_optimization_verifier_config_, deterministic, target);
  }
