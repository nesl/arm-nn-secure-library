...
class MetricEntry : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.MetricEntry) */ {
 public:
  ...
  inline MetricEntry* New() const PROTOBUF_FINAL { return New(NULL); }

  MetricEntry* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_tensorflow_2fcore_2futil_2ftest_5flog_2eproto::TableStruct;
  friend void ::protobuf_tensorflow_2fcore_2futil_2ftest_5flog_2eproto::InitDefaultsMetricEntryImpl();
};
// -------------------------------------------------------------------
