...
void InitDefaultsWatchdogConfigImpl();
void InitDefaultsWatchdogConfig();
void InitDefaultsWorkerHeartbeatRequestImpl();
void InitDefaultsWorkerHeartbeatRequest();
void InitDefaultsWorkerHeartbeatResponseImpl();
void InitDefaultsWorkerHeartbeatResponse();
inline void InitDefaults() {
  InitDefaultsEvent();
  InitDefaultsLogMessage();
  InitDefaultsSessionLog();
  InitDefaultsTaggedRunMetadata();
  InitDefaultsWatchdogConfig();
  InitDefaultsWorkerHeartbeatRequest();
  InitDefaultsWorkerHeartbeatResponse();
}
}  // namespace protobuf_tensorflow_2fcore_2futil_2fevent_2eproto
...
class WatchdogConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.WatchdogConfig) */ {
 public:
  ...
  inline WatchdogConfig* New() const PROTOBUF_FINAL { return New(NULL); }

  WatchdogConfig* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_tensorflow_2fcore_2futil_2fevent_2eproto::TableStruct;
  friend void ::protobuf_tensorflow_2fcore_2futil_2fevent_2eproto::InitDefaultsWatchdogConfigImpl();
};
// -------------------------------------------------------------------
...
class WorkerHeartbeatRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.WorkerHeartbeatRequest) */ {
 public:
  ...
  inline WorkerHeartbeatRequest* New() const PROTOBUF_FINAL { return New(NULL); }

  WorkerHeartbeatRequest* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  ...
  private:
  void _slow_mutable_watchdog_config();
  public:
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_tensorflow_2fcore_2futil_2fevent_2eproto::TableStruct;
  friend void ::protobuf_tensorflow_2fcore_2futil_2fevent_2eproto::InitDefaultsWorkerHeartbeatRequestImpl();
};
// -------------------------------------------------------------------
...
class WorkerHeartbeatResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.WorkerHeartbeatResponse) */ {
 public:
  ...
  inline WorkerHeartbeatResponse* New() const PROTOBUF_FINAL { return New(NULL); }

  WorkerHeartbeatResponse* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_tensorflow_2fcore_2futil_2fevent_2eproto::TableStruct;
  friend void ::protobuf_tensorflow_2fcore_2futil_2fevent_2eproto::InitDefaultsWorkerHeartbeatResponseImpl();
};
// ===================================================================
...
template <> struct is_proto_enum< ::tensorflow::WorkerHealth> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::tensorflow::WorkerHealth>() {
  return ::tensorflow::WorkerHealth_descriptor();
}
template <> struct is_proto_enum< ::tensorflow::WorkerShutdownMode> : ::google::protobuf::internal::true_type {};
template <>
