...
void InitDefaultsEventImpl() {
  ...
  protobuf_tensorflow_2fcore_2futil_2fevent_2eproto::InitDefaultsLogMessage();
  protobuf_tensorflow_2fcore_2futil_2fevent_2eproto::InitDefaultsSessionLog();
  protobuf_tensorflow_2fcore_2futil_2fevent_2eproto::InitDefaultsTaggedRunMetadata();
  {
...
void InitDefaultsLogMessage() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsLogMessageImpl);
}
...
void InitDefaultsSessionLog() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsSessionLogImpl);
}
...
void InitDefaultsTaggedRunMetadata() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsTaggedRunMetadataImpl);
}
...
void InitDefaultsWatchdogConfig() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsWatchdogConfigImpl);
}
...
void InitDefaultsWorkerHeartbeatRequestImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_tensorflow_2fcore_2futil_2fevent_2eproto::InitDefaultsWatchdogConfig();
  {
...
void InitDefaultsWorkerHeartbeatRequest() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsWorkerHeartbeatRequestImpl);
}
...
void InitDefaultsWorkerHeartbeatResponseImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_tensorflow_2fcore_2futil_2fevent_2eproto::InitDefaultsEvent();
  {
...
void InitDefaultsWorkerHeartbeatResponse() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsWorkerHeartbeatResponseImpl);
}
...
WorkerHeartbeatRequest::WorkerHeartbeatRequest()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_tensorflow_2fcore_2futil_2fevent_2eproto::InitDefaultsWorkerHeartbeatRequest();
  }
  SharedCtor();
...
WorkerHeartbeatResponse::WorkerHeartbeatResponse()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_tensorflow_2fcore_2futil_2fevent_2eproto::InitDefaultsWorkerHeartbeatResponse();
  }
  SharedCtor();
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
            static_cast< ::google::protobuf::uint8>(18u /* 18 & 0xFF */)) {
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessage(input, add_worker_log()));
        } else {
          goto handle_unusual;
        }
        break;
